...
from backend.database import engine, Result, Faculty, ResultFaculty, FacultyType, Question, Answer, AnswerFaculty
from backend.schemas import ResponseResult, FacultyTypeSch
